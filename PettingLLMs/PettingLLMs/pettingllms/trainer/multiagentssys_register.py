...
ENV_CLASSES = {
    ...
    # Critic GRPO Environment
    "critic_grpo_env": safe_import("pettingllms.multi_agent_env.critic_grpo.critic_env", "CriticGRPOEnv"),

    # HotpotQA Critic-GRPO environment
    "hotpot_env": safe_import("pettingllms.multi_agent_env.hotpot.hotpot_env", "HotpotEnv"),
}
...
ENV_BATCH_CLASSES = {
    ...
    # Critic GRPO Environment batch
    "critic_grpo_env": safe_import("pettingllms.multi_agent_env.critic_grpo.critic_env", "CriticGRPOEnvBatch"),

    # HotpotQA Critic-GRPO environment batch
    "hotpot_env": safe_import("pettingllms.multi_agent_env.hotpot.hotpot_env", "HotpotEnvBatch"),
}
...
AGENT_CLASSES = {
    ...
    # Critic GRPO agents
    "critic_agent": safe_import("pettingllms.multi_agent_env.critic_grpo.critic_agent", "CriticAgent"),

    # HotpotQA Critic-GRPO agents
    "planner": safe_import("pettingllms.multi_agent_env.hotpot.agents.planner_agent", "PlannerAgent"),
    "critic":  safe_import("pettingllms.multi_agent_env.hotpot.agents.critic_agent",  "CriticAgent"),
}
...
# ============================================================================
ENV_WORKER_CLASSES = {
    "code_env": safe_import("pettingllms.mu.code.code_worker", "get_ray_docker_worker_cls"),
    ...
    "critic_grpo_env": safe_import("pettingllms.multi_agent_env.math.math_worker", "get_ray_docker_worker_cls"), # Reuse existing worker pattern logic

    # HotpotQA Critic-GRPO (reuses math worker – no code execution needed)
    "hotpot_env": safe_import("pettingllms.multi_agent_env.hotpot.hotpot_worker", "get_ray_docker_worker_cls"),
}
